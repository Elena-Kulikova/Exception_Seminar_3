...
public class Main {
    ...
    private static void addContact() {
        try (Scanner scanner = new Scanner(System.in)) {
            System.out.println("Пример ввода данных: Фамилия Имя Отчество Дата_рождения(dd.mm.yyyy) Номер_телефона(цифры) Пол (f или m)");
            System.out.println("Введите данные латинскими буквами через пробел: ");
